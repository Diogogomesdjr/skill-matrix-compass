        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400"><circle cx="12" cy="12" r="10"></circle><path d="M15 9l-6 6"></path><path d="M9 9l6 6"></path></svg>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm">
              <li>• Utilize o controle deslizante para definir o nível da habilidade</li>
              <li>• Clique no ícone ao lado da habilidade para alterar entre apto/não apto</li>
              ...
              <li>• Defina pontos focais utilizando o botão dedicado</li>
              <li>• Use o botão de recolher/expandir para visualizar a matriz de forma compacta</li>
            </ul>
          </div>
        </div>
      </CardContent>
